...
<template>
  <form class="mt-2.5" @submit.prevent="handleSubmit">
    <div class="relative">
      ...
      <button type="submit"
              class="w-auto text-white absolute right-2.5 bottom-2.5 bg-primary-blue hover:bg-blue-800  focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">

...
<template>
  ...
  <div class="tasks-container mt-16 mx-auto">
    ...
    <div role="status">
        <svg aria-hidden="true" class="mb-2.5 inline w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
